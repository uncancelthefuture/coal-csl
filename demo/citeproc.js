...
CSL.Engine.prototype.retrieveItem = function (id) {
    ...
    CSL.ITERATION += 1;
    console.log(JSON.stringify(this.sys.retrieveItem("" + id)))
...
CSL.Engine.prototype.processCitationCluster = function (citation, citationsPre, citationsPost, flag) {
        ...
        if (this.opt.development_extensions.strict_inputs) {
            ...
            if (preCitation[1]) {
                if (lastNotePos > preCitation[1]) {
                    throw "Note index sequence is not sane at citationsPre [" + i + "] -- " + JSON.stringify(citationsPre, null, 2);
                }
    ...
    if (this.opt.development_extensions.strict_inputs) {
        if (citationById[citation.citationID]) {
            throw "Citation with previously referenced citationID " + citation.citationID + " at idx " + citationsPre.length;
        }
